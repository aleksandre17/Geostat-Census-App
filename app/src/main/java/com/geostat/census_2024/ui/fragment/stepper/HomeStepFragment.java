...
import com.geostat.census_2024.databinding.FragmentHomeStepBinding;
 ...
 */
public class HomeStepFragment extends Fragment implements BlockingStep, Stepper {

    private static volatile HomeStepFragment INSTANCE;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        User user = fragmentStepViewModel.getUser();
        ...
        instId.setText(user.getProperty("instr_id"));
        distrId.setText(user.getProperty("distr_id"));
