...
import com.geostat.census_2024.ui.inquire_v1.stepper.handler.SpinnerItemClickListener;
...
public class FirstStepFragment extends Fragment implements BlockingStep {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        try {
            List<BuildingTypeEntity> types = addressViewModel.getAllBuildingType();
            ...
            List<LivingStatusEntity> types2 = addressViewModel.getAllLivingStatus();
    ...
    public void onResume() {
        ...
        Observer<AddressingModel> firstTrigger = addressingModel -> {
        ...
        try {
            List<TagEntity> types = addressViewModel.getTags();
            Collections.reverse(types);

            if (!types.isEmpty()) {
                InterAdapter<TagEntity> interAdapter = new InterAdapter<>(requireActivity(), R.layout.item_alternative, types, addressViewModel::removeTag);
    ...
    public void onBackClicked(StepperLayout.OnBackClickedCallback callback) {
        //        this.fragmentStepViewModel.getVm().removeObserver(FirstTrigger); fragmentStepViewModel.getVm().removeObservers(getViewLifecycleOwner());
