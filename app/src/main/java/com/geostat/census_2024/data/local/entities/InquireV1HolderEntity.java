...
@Entity(foreignKeys = {
        @ForeignKey(entity = InquireV1Entity.class, parentColumns = { "id" }, childColumns = { "addressingId" }, onUpdate = ForeignKey.CASCADE, onDelete = ForeignKey.CASCADE) },
        tableName = "addressing_holders", indices = { @Index("addressingId"), @Index(value = "id", unique = true) }
)
public class InquireV1HolderEntity {
    ...
    public InquireV1HolderEntity(@NonNull String firstName, @NonNull String lastName, @NonNull String fatherName, @NonNull Integer membersNum, @NonNull String mobileNum) {
