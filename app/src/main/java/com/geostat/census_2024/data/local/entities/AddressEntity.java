...
public class AddressEntity {
    ...
    public AddressEntity(@NonNull Integer id, @Nullable Integer parentId, @Nullable String locationCode, @Nullable String locationName, @Nullable Integer locationTypeId, @Nullable Integer urbanTypeId, @Nullable Boolean inactive, @Nullable Integer recUserId, @Nullable String recDate, @Nullable String recType, @Nullable Integer level, @Nullable Integer locationRootId, @Nullable Integer locationMunicId) {
        this.id = id;
